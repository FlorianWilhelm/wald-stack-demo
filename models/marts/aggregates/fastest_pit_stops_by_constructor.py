"""Determine the fastest pit stops"""
...
def model(dbt, session):
    ...
    # describe the data
    pit_stops_joined["PIT_STOP_SECONDS"] = (
        pit_stops_joined["PIT_STOP_MILLISECONDS"] / 1000
    )
    fastest_pit_stops = (
        pit_stops_joined[(pit_stops_joined["RACE_YEAR"] == year)]
        .groupby(by="CONSTRUCTOR_NAME")["PIT_STOP_SECONDS"]
        .describe()
        .sort_values(by="mean")
    )
